...
public class ProtocolChooser {
    private static final Map<Byte, Protocol> protocolMap = Collections.unmodifiableMap(
            new HashMap<Byte, Protocol>() {
                {
                    put(BinaryProtocol.VERSION, BinaryProtocol.instance);
                }
            });
