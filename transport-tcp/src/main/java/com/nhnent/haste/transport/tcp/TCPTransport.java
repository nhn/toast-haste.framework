...
public class TCPTransport extends AbstractTransport {
    ...
    public static class Builder extends AbstractTransport.Builder<Builder, TCPTransport> {
        @Override
